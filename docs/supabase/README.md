...
- `012_coach_network.sql`, Coach Network (find-coach, basvuru, teklif, mesajlasma, remote athlete, `coaching_program_assignments`, proof, review) icin tablolari kurar. Coach Network ozellikleri acilmadan once Supabase SQL Editor'de calistirin. CN4 program atama bu migration'daki `coaching_program_assignments` tablosunu kullanir (`program_metadata.completed_dates` ile uyum %).
